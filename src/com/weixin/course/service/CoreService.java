	...
	public static String processRequest(HttpServletRequest request) {
		...
		try {
			...
			if (msgType.equals(MessageUtil.REQ_MESSAGE_TYPE_TEXT)) {
				...
				/*
				 * // 单图文消息 if ("1".equals(content)) { Article article = new
				 * Article(); article.setTitle("微信公众帐号开发教程Java版");
				 * article.setDescription
				 * ("方便PICC信息技术人员以及公司其他用户交流运维经验、提供运维技术支持、提高运维服务相应速度和服务质量。");
				 * article.setPicUrl(
				 ...
				 * 将图文消息对象转换成xml字符串 respContent =
				 * MessageUtil.messageToXml(newsMessage); } // 单图文消息---不含图片 else
				 * if ("2".equals(content)) { Article article = new Article();
				 * article.setTitle("微信公众帐号开发教程Java版"); // 图文消息中可以使用QQ表情、符号表情
				 * article.setDescription("柳峰，80后，" +
				 * "，微信公众帐号开发经验4个月。为帮助初学者入门，特推出此系列连载教程，也希望借此机会认识更多同行！\n\n目前已推出教程共12篇，包括接口配置、消息封装、框架搭建、QQ表情发送、符号表情发送等。\n\n后期还计划推出一些实用功能的开发讲解，例如：天气预报、周边搜索、聊天功能等。"
				 * ); // 将图片置为空 article.setPicUrl("");
				 * article.setUrl("http://blog.csdn.net/lyq8479");
				 * articleList.add(article);
				 * newsMessage.setArticleCount(articleList.size());
				 * newsMessage.setArticles(articleList); respContent =
				 * MessageUtil.messageToXml(newsMessage); } // 多图文消息 else if
				 * ("3".equals(content)) { Article article1 = new Article();
				 * article1.setTitle("微信公众帐号开发教程\n引言");
				 * article1.setDescription(""); article1.setPicUrl(
				 * "http://ecma.bdimg.com/lego-mat/ae1e7356921c0925a3df77f6c2756566_660_200.jpg"
				 * ); article1.setUrl(
				 ...
				 * ); article2.setUrl(
				 * "http://blog.csdn.net/lyq8479/article/details/8941577");
				 * 
				 ...
				 * newsMessage.setArticleCount(articleList.size());
				 * newsMessage.setArticles(articleList); respContent =
				 * MessageUtil.messageToXml(newsMessage); } // 多图文消息---首条消息不含图片
				 * else if ("4".equals(content)) { Article article1 = new
				 * Article(); article1.setTitle("微信公众帐号开发教程Java版");
				 * article1.setDescription(""); // 将图片置为空
				 * article1.setPicUrl("");
				 ...
				 * article2.setPicUrl("http://avatar.csdn.net/1/4/A/1_lyq8479.jpg"
				 * ); article2.setUrl(
				 * "http://blog.csdn.net/lyq8479/article/details/8949088");
				 * 
				 * Article article3 = new Article();
				 ...
				 * article3.setPicUrl("http://avatar.csdn.net/1/4/A/1_lyq8479.jpg"
				 * ); article3.setUrl(
				 * "http://blog.csdn.net/lyq8479/article/details/8952173");
				 * 
				 ...
				 * ); article4.setUrl(
				 * "http://blog.csdn.net/lyq8479/article/details/8967824");
				 * 
				 * articleList.add(article1); articleList.add(article2);
				 ...
				 * 多图文消息---最后一条消息不含图片 else if ("5".equals(content)) { Article
				 ...
				 * article2.setPicUrl("http://avatar.csdn.net/1/4/A/1_lyq8479.jpg"
				 * ); article2.setUrl(
				 * "http://blog.csdn.net/lyq8479/article/details/9157455");
				 * 
				 * Article article3 = new Article();
				 * article3.setTitle("如果觉得文章对你有所帮助，请通过博客留言或关注微信公众帐号xiaoqrobot来支持柳峰！"
				 * ); article3.setDescription(""); // 将图片置为空
				 * article3.setPicUrl("");
				 ...
				 * newsMessage.setArticleCount(articleList.size());
				 * newsMessage.setArticles(articleList); respContent =
				 * MessageUtil.messageToXml(newsMessage); }else
				 * if("6".equals(content)){ Article article = new Article();
				 * article.setTitle("代驾搜索服务"); article.setDescription("代驾搜索服务");
				 * // 将图片置为空 article.setPicUrl("");
